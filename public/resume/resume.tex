...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Desenvolvedor Full Stack Sênior $\cdot$ Typescript / Python / Go / Node -- São Paulo, Brasil & Telefone : +55 11 95884-3078 \\
...
\section{Habilidades}
 \resumeSubHeadingListStart
   ...
   \item{
     \textbf{Dados, IA \& Scraping}{: Pandas, BeautifulSoup, Scrapy, LLMs / IA aplicada, Data Visualization, bancos relacionais (SQL), Firebase, Supabase}
   }
   \item{
