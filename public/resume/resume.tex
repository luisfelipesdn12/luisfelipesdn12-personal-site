...
%-----------PERFIL-----------------
\section{Perfil}
\small Desenvolvedor full stack sênior com experiência sólida em \textbf{C\#/.NET, Java e TypeScript}, criando e evoluindo \textbf{APIs RESTful seguras, performáticas e escaláveis}. Atuação em \textbf{telecom B2B na Allcom Telecom} (maior operadora de IoT da América Latina), atendendo grandes clientes corporativos, onde \textbf{coordenei time e arquitetei soluções}. Forte em \textbf{SQL Server} e bancos relacionais, \textbf{microsserviços e mensageria (RabbitMQ)}, \textbf{CI/CD e Docker}, com prática consistente de \textbf{Clean Code, SOLID e TDD} em times ágeis (Scrum/Kanban) e multidisciplinares (QA, DevOps, Produto).
\vspace{2pt}
...
\section{Experiência}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Desenvolvimento Web Full-Stack}
          {Desenvolvimento full-stack de plataforma SaaS com Python, Node, expondo APIs RESTful, interfaces internas e dashboards \textit{data-driven}. Automações, web scraping e integrações com modelos de IA/LLMs, com foco em arquitetura, performance e escalabilidade.}
        \resumeItem{Microsserviços, Mensageria e CI/CD}
          {Arquitetura de sistemas em microsserviços com mensageria (Go), pipelines de CI/CD na AWS e GitHub, e garantia de qualidade com TDD e testes de integração.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Plataforma IoT em escala (4M+ dispositivos, 8.000+ clientes)}
          {Atuação em produtos da maior operadora de IoT da América Latina, com clientes B2B e parceiros estratégicos como \textbf{Claro, Vivo, Qualcomm e Nokia}. Desenvolvimento web full-stack com C\#/.NET, Next.js, Node, React, Laravel, Python, Docker e \textbf{SQL Server}. APIs RESTful seguras e escaláveis, microsserviços e mensageria (RabbitMQ), automações e interfaces internas para segmentos de meios de pagamento (POS), smart cities, utilities, telemetria e frotas.}
        \resumeItem{Coordenação Técnica e Arquitetura}
          {Coordenação de time e arquitetura de soluções junto a equipes multidisciplinares, definindo padrões técnicos e garantindo qualidade com Clean Code, SOLID e testes.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Desenvolvimento Web Full-Stack}
          {Desenvolvimento web front e back-end com C\#/.NET, Angular, Node, Python, React e Docker. APIs RESTful, automações, web scraping e bancos relacionais sob metodologias ágeis.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Desenvolvimento Web Full-Stack}
          {Desenvolvimento web front e back-end com C\#/.NET, Angular, Next, React, Firebase e Supabase. Construção de APIs RESTful, integrações de dados e entrega contínua em metodologias ágeis.}
      \resumeItemListEnd
...
\section{Habilidades}
 \resumeSubHeadingListStart
   \item{
     \textbf{Linguagens}{: C\# / .NET, Java, TypeScript, JavaScript (ES6+), Python, Go, Node.js, Dart, Arduino}
   }
   \item{
     \textbf{Dados, IA \& Scraping}{: SQL Server (modelagem, consultas e otimização), Grafana, Pandas, BeautifulSoup, Scrapy, LLMs / IA aplicada, Data Visualization, Firebase, Supabase}
   }
   \item{
     \textbf{Web \& APIs}{: APIs RESTful seguras e escaláveis, Angular, React, Next.js, GraphQL, Express, Laravel, Flutter, UI/UX, Acessibilidade digital}
   }
   \item{
     \textbf{Infra \& Cloud}{: AWS, Docker, CI/CD, Microsserviços, Mensageria (RabbitMQ), Git/GitHub, Arquitetura de Sistemas}
   }
   \item{
     \textbf{Práticas}{: Clean Code, SOLID, TDD, Testes unitários e de integração, Automação, Metodologias Ágeis (Scrum/Kanban), LGPD}
   }
   \item{
